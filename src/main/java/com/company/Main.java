//1. далее надо сделать после нажатия кнопки addType/addBrand/addProduct всплывающее окно и туда вводить параметры, а не в общее поле вводить слово.


//нужно будет добавить сохранение таблицы в локалный репозиторий и загрузку
...
//trouble2(done)
//при нажатии кнопки deleteTable удаляется не таблица а панель для кнопок. нужно научиться обновлять таблицы , а не удалять и потом создавать заного
